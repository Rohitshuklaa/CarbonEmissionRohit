...
import { EnergySectionComponent } from '@pages/energy-section/energy-section.component';
import { EmissionSectionComponent } from '@pages/emission-section/emission-section.component';
